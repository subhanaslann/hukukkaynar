...
const densityLabels: Record<AnimDensity, string> = {
  off: 'Kapalı',
  lite: 'Az',
  rich: 'Orta',
  max: 'Çok'
  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        aria-label="Animasyon yoğunluğu ayarları"
        title="Animasyon yoğunluğu"
      >
